#pragma once
// Designed class for the computation of conditionnal expectation 
#include <vector>
#include <iostream>
#include <algorithm>
using namespace std;
...
protected:
	...
	virtual Vector bins_creation_manner(const Vector& spot) const = 0;
public:
...
{
protected:
	Vector bins_creation_manner(const Vector& spot) const override;
public:
